        ...
        <div className='footer'>
            <div className='footer-container'>
                <div className='footer-rights-container'>
                    ...
                    <Link to='/terms-and-conditions' className='footer-rights' onClick={backToTop}>{t('Footer.Info2')}</Link>
                    <Link to='/privacy-policies' className='footer-rights' onClick={backToTop}>{t('Footer.Info')}</Link>
                    <Link to='/cookie-consent' className='footer-rights' onClick={backToTop}>{t('Footer.Info3')}</Link>
                </div>
